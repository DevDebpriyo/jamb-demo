...
export type FeaturedGridCardImage = {
  asset?: SanityImageAssetReference;
  media?: unknown; // Unable to locate the referenced type "featuredGridCard.image.media" in schema
  hotspot?: SanityImageHotspot;
  crop?: SanityImageCrop;
  alt?: string;
  _type: "image";
...
export type FeaturedGrid = {
  ...
  subtitle?: string;
  cards?: Array<{
    image: FeaturedGridCardImage;
    aspectRatio: "square" | "portrait" | "landscape";
    title?: string;
    description?: string;
    _type: "featuredGridCard";
    _key: string;
  }>;
};
...
// Query: *[_type == "footer" && _id == "footer"][0]{    _id,    newsletterText,    columns[]{      _key,      title,      topText,      showNewsletter,      groups[]{        _key,        title,        links[]{          _key,          name,          "openInNewTab": url.openInNewTab,          "href": select(            url.type == "internal" => url.internal->slug.current,            url.type == "external" => url.external,            url.href          ),        }      }    }  }
